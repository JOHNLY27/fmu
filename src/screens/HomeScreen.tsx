      ...
      >
        ...
        <Animated.View style={{ opacity: fadeAnim, transform: [{ translateY: slideAnim }] }}>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.storesScroll}>
             {[
               { name: 'Gaisano Mall', type: 'Supermarket', img: 'https://images.unsplash.com/photo-1534452203293-494d7ddbf7e0?w=400' },
               { name: 'Mercury Drug', type: 'Pharmacy', img: 'https://images.unsplash.com/photo-1586015555751-63bb77f4323a?w=400' },
               { name: 'Robinsons', type: 'Department Store', img: 'https://images.unsplash.com/photo-1567401893414-76b7b1e5a7a5?w=400' },
             ].map((store, i) => (
                <TouchableOpacity key={i} style={styles.storeCard} onPress={() => navigation.navigate('StoreDirectory')}>
                   <Image source={{ uri: store.img }} style={styles.storeImg} />
